 ...
 * @author LuoMJ
 * @version 0.1
 * Expend Ext.PagingToolbar
 */
  
Ext.ResetPageNumToolbar = Ext.extend(Ext.Toolbar,{
    /**
    ...
    onLoad : function(store, r, o){
       ...
       if (getCookie("isSort") == "true") {
       	   this.field.dom.value = 1;	
       }
       deleteCookie("isSort", path);
...
Ext.reg('resetpaging', Ext.ResetPageNumToolbar);