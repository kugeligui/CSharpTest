 ...
 */
Ext.ColorableTabPanel = Ext.extend(Ext.Panel,  {
    /**
...
&lt;/div>
    ...
    initComponent : function(){
        this.frame = false;
        Ext.ColorableTabPanel.superclass.initComponent.call(this);
        this.addEvents(
            /**
        ...
        if(!this.stack){
            this.stack = Ext.ColorableTabPanel.AccessStack();
        }
        this.initItems();
    },
    ...
    // private
    render : function(){
        Ext.ColorableTabPanel.superclass.render.apply(this, arguments);
    ...
    onRender : function(ct, position){
        Ext.ColorableTabPanel.superclass.onRender.call(this, ct, position);
        ...
        this.stripWrap = st.createChild({cls:'x-tab-strip-wrap', cn:{
            tag:'ul', cls:'x-tab-strip x-colortab-strip-'+this.tabPosition}});
        ...
        if(!this.itemTpl){
            ...
            tt.compile();
            Ext.ColorableTabPanel.prototype.itemTpl = tt;
        }
    ...
    afterRender : function(){
        Ext.ColorableTabPanel.superclass.afterRender.call(this);
        if(this.autoTabs){
            this.readTabs(false);
        }
    },
    ...
    // private
    initEvents : function(){
        Ext.ColorableTabPanel.superclass.initEvents.call(this);
    ...
    onBeforeAdd : function(item){
        ...
        Ext.ColorableTabPanel.superclass.onBeforeAdd.apply(this, arguments);
    ...
    // private
    onResize : function(){
        Ext.ColorableTabPanel.superclass.onResize.apply(this, arguments);
        this.delegateUpdates();
    },
    ...
    setActiveTab : function(item){
        ...
        if(this.activeTab != item){
            if(this.activeTab){
                ...
                if(oldEl){
                    Ext.fly(oldEl).removeClass('x-colortab-strip-active');
                }
                this.activeTab.fireEvent('deactivate', this.activeTab);
            }
            var el = this.getTabEl(item);
            Ext.fly(el).addClass('x-colortab-strip-active');
            this.activeTab = item;
            this.stack.add(item);
...
Ext.reg('ColorableTabPanel', Ext.ColorableTabPanel);
 ...
 * @method activate
 */
Ext.ColorableTabPanel.prototype.activate = Ext.ColorableTabPanel.prototype.setActiveTab;

// private utility class used by TabPanel
Ext.ColorableTabPanel.AccessStack = function(){
    var items = [];
    return {
        add : function(item){
            items.push(item);
